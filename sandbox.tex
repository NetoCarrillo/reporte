...
\subsubsection{Persistencia}
	\paragraph{Almacenamiento\\}
		\textbf{guardar-nueva}
		\textbf{cambiar-estado}
		\textbf{guardar-respuesta}
		\textbf{guardar-folio-acuse}
		\textbf{actualizar-estado-sa}
		\textbf{registrar-evento}
	\paragraph{Lectura\\}
		\textbf{siguiente-orden-contestar}
		\textbf{siguiente-orden-enviar}
		\textbf{obtener-datos-acuse}
	\paragraph{Administración\\}
		\textbf{buscar-credenciales}
		\textbf{extraer-reporte}
		\textbf{actualizar-catalogo}
		\textbf{buscar-ordenes}
		\textbf{buscar-orden}
		\textbf{actualizar-orden}
\subsubsection{Sistema de archivos}
	\paragraph{Configuración\\}
