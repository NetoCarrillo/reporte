...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{maq-login} 
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1]{maq-search} 
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1]{maq-report} 
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=1]{maq-upload}
...
\end{figure}
\newline Con el fin de explicar mejor el flujo de atención de una orden de reposición, es necesario mostrar el diagrama de estados de una orden de reposición durante el flujo de \textbf{envío de órdenes de reposición} (sección \ref{sec:intro-contexto}).\\
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-estados-orden} 
  \caption{Diagrama de estados de una orden de reposición durante la rutina de respuesta.}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-activity-login}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-activity-reporter}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-activity-cat-update}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-activity-search}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.4]{dia-activity-view}
  \caption{Diagrama de actividad de la visualización de una orden de reposición.}
