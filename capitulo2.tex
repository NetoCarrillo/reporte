...
\begin{itemize}
  \item Si la solicitud está lista para ser procesada: \consolatext{Nueva} o \consolatext{Contestada}.
  \item Si está siendo procesada: \consolatext{Siendo Contestada} o \consolatext{Siendo Enviada}.
  \item Si ha terminado el ciclo correctamente: \consolatext{Enviada}.
  \item Si ha terminado el ciclo con errores: \consolatext{Error}.
\end{itemize} 
