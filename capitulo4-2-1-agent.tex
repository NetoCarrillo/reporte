...
_click(_image("Normal[2]"));
	...
	\item Recolectar las órdenes de reposición listadas, el Código \ref{lst:sah-save-news} muestra un resumen de la automatización para guardar el listado de órdenes de reposición (ver caso de uso \textbf{CU-GUARDAR-NUEVA}):
	\begin{enumerate}
...
for(var $i = 1 + $errores; $i <= $rowCount; $i++){
	...
	\item Contestar cada orden de reposición, el Código \ref{lst:sah-respond} muestra un resumen de la automatización para contestar una orden de reposición (ver caso de uso \textbf{CU-RESPONDER-ORDEN}):
	\begin{enumerate}
...
$logica.updateCantidad($contrato, $numorden, $cantidad, $idSesion);
	...
	\item Enviar las órdenes de reposición contestadas. El Código \ref{lst:sah-send} muestra un resumen de la automatización para enviar una orden de reposición (ver caso de uso \textbf{CU-ENVIAR-ORDEN}):
	\begin{enumerate}
