...
La implementación del Portal Web se ha hecho siguiendo la Arquitectura Orienta a Servicios, lo cual implica que por una parte se tiene un servidor que expone tales servicios a través de la Web, y por otro lado un cliente que los consume. Mientras que la implementación del cliente que consume los servicios Web se ha hecho utilizando el lenguaje Javascript y el marco de trabajo AngularJS, AngularJS sigue el patrón de diseño MVC.\\
El manejo de autentificación y autorización de usuarios se ha hecho siguiendo la especificación OAuth 2.0.
