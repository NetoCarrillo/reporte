...
\textcolor{red}{mencionar el flujo de autenticar usuarios}.

\subsection{Solución a casos de uso}
\textcolor{red}{Describir los flujos entre componentes que solucionan cada caso de uso.}
\textcolor{red}{Mencionar conceptos de arquitectura}
\textcolor{red}{Mencionar conceptos de diseño de patrones}

\subsubsection{Contestar órdenes}
\textcolor{red}{insertar diagrama de secuencia}
...
\iffalse
	...
	\begin{tabular}{|p{\dimexpr.2\textwidth}|p{\dimexpr.8\textwidth-4\tabcolsep}|}
		\hline
		\textbf{Identificador}	& \textbf{}\\
		\hline
		\hline
		\textbf{Descripción}	& .\\
		\hline
		\multirow{2}{*}{\textbf{Parámetros}}	& \textbullet\, .\\
												& \textbullet\, .\\
		\hline
		\textbf{Resultado}		& .\\
		\hline
