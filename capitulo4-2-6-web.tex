...
La vista \textbf{Catálogos} ofrece al usuario la operación para actualizar éstos. Contiene las opciones para seleccionar el catálogo con el cuál se trabajará. En el Código \ref{lst:view-catalog-tmpl} se muestra la estructura principal de la plantilla:\\
\begin{adjustwidth}{\listingfixwidth}{0pt}
