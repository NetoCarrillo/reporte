...
\begin{itemize}
 	\item Spring boot: provee un ambiente de desarrollo y ejecución para aplicaciones basadas en el marco de trabajo \textit{Spring} (ver sección \ref{sec:spring-boot}). 
...
Los servicios para autentificar y validar usuarios se implementaron siguiendo la especificación OAtuh 2.0 (ver sección \ref{sec:oauth}), el marco de trabajo \textit{Spring} con sus bibliotecas \textit{Spring boot} y \textit{Spring security}.\\
